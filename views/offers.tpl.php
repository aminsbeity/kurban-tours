                  ...
                  <tr>
                    <td width="654" align="left" valign="top">
                    	<div style="padding:23px 16px ">
                            ...
                            <?php foreach ($offerArray as $offerRow){ ?>
                            <div style="margin-top:10px">
                           		<div style="position:relative;width:600px;" >
                                	<div class="bgCaption offerClass" style="padding:10px;" > 
                                		<div>
                                    		<div class="tahoma font20px yellow"><?php echo $offerRow->destination_name ?></div>
                                        	<div class="tahoma font14px grayLight"><?php echo $formatClass->formatDay($offerRow->offer_date); ?></div>
                                        </div>
                                        <div style="padding-top:10px;" class="tahoma font13px white" align="justify">
                                        	 <?php echo $offerRow->offer_details?>
                                        </div>
                                    </div>
                                    ...
                                    <div style="width: 620px;height: 266px;overflow: hidden;">
                                		<img src="<?php echo $appClass->getImage($offerRow->offer_image) ?>"  border="0" width="620" />
                                	</div>	
                                	<?php } ?>
                                </div>
                            </div>
