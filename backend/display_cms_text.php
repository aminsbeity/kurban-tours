...
if($keywords != ""){
	$condition.=" cms_text_title like '%$keywords%' and ";
}
...
$offset = 0;
$page=$_REQUEST["page"];
$recordsCount = Cms_text::count($condition);
...
$records = Cms_text::select($condition);
...
<div style="border:0px; padding:3px; background-color: #f3f3f3; font-weight: bold;color:#0569c5;font-size:18px;" align="center">CMS text Management</div>
...
<div style="">
	<a href="new_cms_text.php"><img src="images/new.png" border="0"/></a>
</div>
<form name="myform" action="delete_cms_text.php" method="post">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="35" style="border-bottom:1px solid #e5eaef;">&nbsp;</td>
    <td width="100" class="TdHeaders TdHeaderBorder" >Cms text id</td>
	<td class="TdHeaders TdHeaderBorder">Cms text title<br/><a href="?orderBy=asc&fieldName=Cms_text_title">Asc</a>|<a href="?orderBy=desc&fieldName=Cms_text_title">Desc</a></td>
  ...
  $cms_text = $records[$rc];?>
  <tr>
    <td width="35" class="TdBodyborder" ><input type="checkbox" value="<?=$cms_text->cms_text_id;?>" name="check_list<?=$rc;?>"/></td>
    <td width="100" class="TdBodyborder"><?=$cms_text->cms_text_id;?>&nbsp;</td>
    <td class="TdBodyborder"><?=$cms_text->cms_text_title;?>&nbsp;</td>
	<td class="TdBodyborder">
		<?php $cmsTextLink =  SITE_LINK."read-text/$cms_text->cms_text_id";  ?>
	  	<a href="<?php echo $cmsTextLink ?>" target="_blank"><?php echo $cmsTextLink ?></a>
  	</td>

    <td width="50" align="center" style="border-bottom:1px solid #e5eaef;border-Left:1px solid #e5eaef;" ><a href="edit_cms_text.php?id=<?=$cms_text->cms_text_id?>"><img src="images/edit.png"  height="25" border="0"></a></td>
