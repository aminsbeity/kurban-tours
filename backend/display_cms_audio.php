...
if($keywords != ""){
	$condition.=" $fieldName like '%$keywords%' and ";
}
...
$offset = 0;
$page=$_REQUEST["page"];
$recordsCount = Cms_audio::count($condition);
...
$records = Cms_audio::select($condition);
...
<div style="border:0px; padding:3px; background-color: #f3f3f3; font-weight: bold;color:#0569c5;font-size:18px;" align="center">CMS Audio Management</div>
...
<div style="">
	<a href="new_cms_audio.php"><img src="images/new.png" border="0"/></a>
</div>
<form name="myform" action="delete_cms_audio.php" method="post">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="35" style="border-bottom:1px solid #e5eaef;">&nbsp;</td>
    <td width="100" class="TdHeaders TdHeaderBorder" >audio id</td>
	<td class="TdHeaders TdHeaderBorder">audio title<br/><a href="?orderBy=asc&fieldName=audio_title">Asc</a>|<a href="?orderBy=desc&fieldName=audio_title">Desc</a></td><td class="TdHeaders TdHeaderBorder">audio file<br/><a href="?orderBy=asc&fieldName=audio_file">Asc</a>|<a href="?orderBy=desc&fieldName=audio_file">Desc</a></td>
	<td class="TdHeaders TdHeaderBorder">URL to be used as link</td>
	<td class="TdHeaders TdHeaderBorder">File</td>
    <td colspan="2" class="TdHeaders TdHeaderBorder">Actions</td>
  </tr>
  <?
  for($rc=0;$rc<count($records);$rc++){
  $cms_audio = $records[$rc];?>
  <tr>
    <td width="35" class="TdBodyborder" ><input type="checkbox" value="<?=$cms_audio->cms_audio_id;?>" name="check_list<?=$rc;?>"/></td>
    <td width="100" class="TdBodyborder"><?=$cms_audio->cms_audio_id;?>&nbsp;</td>
    <td class="TdBodyborder"><?=$cms_audio->cms_audio_title;?>&nbsp;</td>
	<td class="TdBodyborder"><?=$cms_audio->cms_audio_file;?>&nbsp;</td>
	
	<td class="TdBodyborder">
	<?php $cmsAudioLink = SITE_LINK."read-audio/$cms_audio->cms_audio_id" ?>
	<a href="<?php echo $cmsAudioLink ?>" target="_blank"><?php echo $cmsAudioLink ?></a>
	</td>
	<td class="TdBodyborder"><a href="<?=$audioPath.$cms_audio->cms_audio_file?>" target="_blank">[ Download File ]</a></td>
	

    <td width="50" align="center" style="border-bottom:1px solid #e5eaef;border-Left:1px solid #e5eaef;" ><a href="edit_cms_audio.php?id=<?=$cms_audio->cms_audio_id?>"><img src="images/edit.png"  height="25" border="0"></a></td>
